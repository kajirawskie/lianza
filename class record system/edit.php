...
if(isset($_POST['update']))
{
    ...
    $query="UPDATE auth set mail='$username', user='$email', password='$password' where id='$id'";
                            ...
                            <form  method="POST">
                             ...
                             <?php   if(isset($_POST['edit']))
                                ...
                                foreach($query_run as $row)
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="username" value="<?php echo $row['mail']?>" class="form-control " placeholder="UserName">
                                    </div><br>
                                    <div class="form-group">
                                        <input type="text"name="email" value="<?php echo $row['user']?>" class="form-control " placeholder="Email Address">
                                    </div><br>
                                    <div class="form-group">
                                        <input type="text" name="password" value="<?php echo $row['password']?>" class="form-control " placeholder="Password">
                                    </div><br>
                                    <div class="form-group">
                                        <input type="text" name="usertype" value="<?php echo $row['tuser']?>" class="form-control " >
                                    </div><br>
